 ...
 * サインインコンポーネント
 *
 * 美しいグラデーション背景とガラスモーフィズムエフェクトを持つ
 * モダンなサインインフォームを提供します。
 *
 * 主な機能:
...
export function SignInForm({
  ...
  /**
   * フォーム送信ハンドラー
   * デフォルトの送信動作を防ぎ、onSubmitコールバックを実行します
   */
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <button
                    ...
                    disabled={isLoading}
                  >
                    {/* パスワード表示/非表示アイコンの条件分岐 */}
                    {showPassword ? (
                      // パスワードが表示されている時のアイコン（目に斜線）
                      <svg
